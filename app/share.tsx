...
import { DEFAULT_CURRENCY, streakDays, moneySaved, formatMoney, recoveryFreeLabel, currentStreakStart } from '@/domain/gambling';
...
export default function ShareCard() {
  ...
  const freeLabel = recoveryFreeLabel(profile.addictionType, profile.addictionDetail);
